...
def mock_schedule_appointment(patient_name: str, patient_cpf: str, date_time: str) -> bool:
    """Mock API para confirmar um agendamento."""
    logger.info(f"Agendamento confirmado no sistema externo para: {patient_name} (CPF: {patient_cpf}) no dia/hora: {date_time}")
    return True
