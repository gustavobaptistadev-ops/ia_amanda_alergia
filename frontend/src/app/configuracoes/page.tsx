...
import { QrCode, Smartphone, RefreshCw, Key, CheckCircle2, AlertCircle, Cpu, Sliders, Save, Sparkles, Loader2 } from "lucide-react";
import { useState, useEffect } from "react";
import Image from "next/image";

export default function Configuracoes() {
  const [activeTab, setActiveTab] = useState<"whatsapp" | "ai">("ai");
