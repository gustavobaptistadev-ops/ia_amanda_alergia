...
const CalendarView = dynamic(() => import('./CalendarView'), { ssr: false, loading: () => <div className="h-[700px] flex items-center justify-center text-slate-500"><Loader2 className="w-8 h-8 animate-spin" /></div> });
    ...
    <div className="space-y-6 animate-in fade-in duration-500 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          <div className="flex bg-slate-100 p-1 rounded-xl">
            ...
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-sm font-semibold transition-colors ${viewMode === "list" ? "bg-white text-blue-600 shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
            >
              Lista
            </button>
          </div>
      ...
      {viewMode === "calendar" ? (
        <CalendarView 
          ...
          onSelectEvent={(appt) => handleOpenEdit(appt)} 
        />
      ) : (
